...
- Lunney & Lueder, "Postmortem Culture: Learning from Failure" — https://sre.google/sre-book/postmortem-culture/ — formalizes: applies the pattern at organizational scale — Google SRE's blameless postmortem practice requires a written root-cause diagnosis before closing any incident, structurally preventing symptom patches from being accepted as complete fixes
