...
- 2389 Research, fresh-eyes-review — https://github.com/2389-research/fresh-eyes-review — first-party: a mandatory review gate that runs after tests pass but before any commit or PR — "NO COMMIT WITHOUT FRESH-EYES REVIEW FIRST" — built on the observation that "Tests are comprehensive" and "I'm confident it's correct" are exactly the circumstances when critical bugs escape
