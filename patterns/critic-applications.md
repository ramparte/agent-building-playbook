...
- Shinn et al., "Reflexion: Language Agents with Verbal Reinforcement Learning" (arXiv:2303.11366) — https://arxiv.org/abs/2303.11366 — classic antecedent: agents reflect verbally on task feedback signals — external (such as test results) or internally simulated — and iterate against them across attempts, a critic signal distinct from the model's in-the-moment self-assessment
