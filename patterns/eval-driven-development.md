...
- Anthropic — https://www.anthropic.com/research/building-effective-agents — Building Effective Agents: recommends starting with simple prompts and optimizing them "with comprehensive evaluation" before adding agentic complexity — the measurement exists before the architecture grows — and catalogs the evaluator-optimizer workflow, in which one LLM generates while another provides evaluation and feedback in a loop
