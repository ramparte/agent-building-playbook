...
- LangChain Team — https://www.langchain.com/blog/context-engineering-for-agents — origin: coins the exact four-bucket taxonomy (write, select, compress, isolate) and frames context engineering as "the #1 job of engineers building AI agents"
