...
- Anthropic — https://www.anthropic.com/research/building-effective-agents — Building Effective Agents: identifies tool design and orchestration as the engineering surfaces demanding the most careful attention — consistent with this pattern's emphasis on locating hard dependencies before implementation
- Amplifier — https://github.com/microsoft/amplifier — The multi-agent patterns in Amplifier emerge from repeated contact with the genuinely difficult parts of agent orchestration: context limits, delegation economics, state handoff — not from upfront architectural speculation (a development-history claim from the Amplifier team's white papers, not verifiable from the public repos)
