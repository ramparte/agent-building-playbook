...
- Ralf D. Müller (rdmueller) — https://github.com/lexler/augmented-coding-patterns/blob/main/documents/patterns/semantic-anchors.md — "Semantic Anchors," the source this pattern is adapted from; reports a systematic test (63 anchors, 193 questions, 3 models) where naming a methodology scored 96–99% while an unnamed paraphrase of the same concept dropped to 0%
