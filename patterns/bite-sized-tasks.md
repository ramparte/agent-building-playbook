...
- Bill Wake, "INVEST in Good Stories, and SMART Tasks" — https://xp123.com/articles/invest-in-good-stories-and-smart-tasks/ — classic antecedent: the "Small" criterion in INVEST holds that a story too large to estimate is too risky to start; tasks earn the right to be worked by being independently completable
