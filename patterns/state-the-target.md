...
- Juan Michelini (juanmichelini) — https://github.com/lexler/augmented-coding-patterns/blob/main/documents/patterns/point-the-target.md — "Point the Target," the source this pattern is adapted from
- Juan Michelini (juanmichelini) — https://github.com/lexler/augmented-coding-patterns/blob/main/documents/obstacles/negative-bleedthrough.md — "Negative Bleedthrough," the companion obstacle write-up describing the underlying mechanism
- Kassner & Schütze (2020) — https://aclanthology.org/2020.acl-main.698/ — "Negated and Misprimed Probes for Pretrained Language Models: Birds Can Talk, But Cannot Fly," ACL 2020 research (cited by the source) showing pretrained language models handle negation poorly
