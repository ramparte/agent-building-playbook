...
- Drew Breunig — https://www.dbreunig.com/2025/06/22/how-contexts-fail-and-how-to-fix-them.html — "How Long Contexts Fail" (June 2025): formalizes: names context poisoning — when a hallucination or error embeds in context and compounds across steps — as the failure mode this pattern addresses; parallel identification of the same root problem from practitioner observation
