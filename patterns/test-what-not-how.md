...
- Anthropic — https://www.anthropic.com/research/building-effective-agents — Building Effective Agents: notes that coding agents' solutions can be verified through automated tests — an output-correctness evaluation stance rather than a check of intermediate tool sequences
