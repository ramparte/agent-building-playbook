...
- Robert G. Cooper, "Stage-Gate Systems: A New Tool for Managing New Products" (*Business Horizons*, 1990) — https://ideas.repec.org/a/eee/bushor/v33y1990i3p44-54.html — classic antecedent (link is IDEAS/RePEc bibliographic metadata; the 1990 article has no stable open-access home): introduced the stage-gate system of formal checkpoints requiring explicit go/kill decisions before work advances to the next phase
