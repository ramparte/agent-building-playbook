...
- 2389 Research, test-kitchen — https://github.com/2389-research/test-kitchen — first-party: "You have a spec. Three valid approaches exist." — instead of guessing which to build, it builds all of them in parallel git worktrees and lets the tests pick the winner, with a design-exploration gate (omakase-off) before building and an implementation competition (cookoff) at the design-to-implementation transition
- 2389 Research, jam — https://github.com/2389-research/jam — first-party: diverse perspective panels propose approaches, three to five variants get built in parallel worktrees, and a review panel evaluates them all — premised on the view that a single agent generating "multiple approaches" is still one mind imagining what different people would think, and that the process should refuse "to throw away what the losers figured out"
